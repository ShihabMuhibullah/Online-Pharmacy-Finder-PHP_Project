...
<body>
	...
	<?php
		...
		if(isset($_POST['search2']))
		{
    				...
    				$sql = "SELECT * FROM pharmacytable2 WHERE Name LIKE '%$searchkey2%' ";
    			
    				} else {
    						$sql = "SELECT * FROM pharmacytable2";
	...
	?> 
      <form align="right" method="post">
        <input type="text" name="search2" class="form-control" placeholder="Search Your Medicine">
        <br>
        <button type="submit" name="back2" class="btn-success btn-lg">Go Back</button>
