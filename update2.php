...
if(isset($_POST['done2'])){
  ...
  $q = "UPDATE pharmacytable2 set ID='$ID', Name='$Name', DrugsFor='$DrugsFor', Manufacturer='$Manufacturer', Price='$Price' where ID=$ID";
...
<body>
	...
	<div class="col-lg-6 m-auto">
		...
		<form method="post">
			...
			<button class="btn btn-warning" type="submit" name="Cancel2"> Cancel </button><br>
