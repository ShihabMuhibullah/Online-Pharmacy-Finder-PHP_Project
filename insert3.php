...
if(isset($_POST['done3'])){
  ...
  $q = " INSERT INTO `pharmacytable3`(`ID`,`Name`, `DrugsFor`, `Manufacturer`, `Price`, `By`) VALUES ( '$ID','$Name', '$DrugsFor', '$Manufacturer', '$Price', 'Khandakar Pharma')";
...
<body>
	...
	<div class="col-lg-6 m-auto">
		...
		<form method="post">
			...
			<button class="btn btn-warning" type="submit" name="back3"> Go Back to Display Page </button><br>
